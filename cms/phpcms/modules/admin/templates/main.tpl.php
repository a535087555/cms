...
<div class="col-2 lf mr10" style="width:48%">
	...
	<?php echo L('main_product_site')?><a href="http://www.phpcms.cn/" target="_blank">http://www.ily365.cn/</a> <br />
	
	<?php echo L('main_product_qq')?>xxxx <br />
	<?php echo L('main_product_sales')?>xxxx
	</div>
</div>
